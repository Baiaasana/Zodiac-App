...
import com.example.recyclerviewgrid.diffUtils.PersonDiffCallback
                    ...
                    R.id.menu_edit -> {
                        ...
                        AlertDialog.Builder(context)
                            ...
                            .setPositiveButton(context.getString(R.string.save)) { dialog, _ ->
                                ...
                                when (false) {
                                    !isEmptyField(firstName, lastName, sign) -> Toast.makeText(
                                        context,
                                        ...
                                        Log.d("add", "user remove for update, ${listOfItems.size}")
                                        listOfItems.add(adapterPosition,
                                            Person(firstName,
                                                withPhoto,
                                                lastName,
                                                sign,
                                                userID = model.userID))
                                        submitList(listOfItems.toList())
                                        Log.d("add", "user added for update, ${listOfItems.size}")
                    ...
                    R.id.menu_delete -> {
                        ...
                        AlertDialog.Builder(context)
                            ...
                            .setPositiveButton(context.getString(R.string.yes)) { dialog, _ ->
                                listOfItems.removeAt(adapterPosition)
                                submitList(listOfItems.toList())
                                Log.d("add", "user removed, ${listOfItems.size}")
                                Toast.makeText(context,
